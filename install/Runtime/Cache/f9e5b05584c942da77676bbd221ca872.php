...
</style><!--main--><div class="midder"><div class="main"><h1>成功安装完成！</h1><p><?php echo L('step_finish_desc');?></p><table class="form-table"><tbody><tr><th>登录Email：</th><td><code><?php echo ($email); ?></code></td></tr><tr><th>登录密码：</th><td><code><?php echo ($password); ?></code></td></tr></tbody></table><p class="step"><a class="button" href="<?php echo ($home_url); ?>">进入前台</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="button" href="<?php echo ($admin_url); ?>">进入后台</a></p></div></div><!--footer--><div class="footer">Powered by <a href="<?php echo (IKPHP_SITEURL); ?>" target="_blank"><?php echo (IKPHP_SITENAME); ?></a>&nbsp;版本 <?php echo (IKPHP_VERSION); ?> &copy; <?php echo (IKPHP_YEAR); ?></div></body></html>