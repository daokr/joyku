...
<img alt="<?php echo ($item["title"]); ?>" class="J_img J_decode_img" data-uri="<?php echo base64_encode(attach(get_thumb($item['img'], '_m'), 'item'));?>" >
        ...
        <div class="favorite"> 
            ...
            <div class="J_like_n like_n"><a href="" target="_blank"><?php echo ($item[likes]); ?></a><i></i></div>
        ...
        <!--评论-->
 		<?php if(!empty($item['comment_list'])): ?><ul class="rep_list">
            <?php $__FOR_START_23112__=0;$__FOR_END_23112__=C('pin_item_cover_comments');for($i=$__FOR_START_23112__;$i < $__FOR_END_23112__;$i+=1){ if(!empty($item['comment_list'][$i])): ?><li class="rep_f">
