...
<form method="POST" action="<?php echo U('article/admin/cate',array('ik'=>'edit','cateid'=>$strCate[cateid]));?>">
<table cellpadding="0" cellspacing="0">

	<tr>
		<th>分类名称：</th>
		<td><input name="catename" value="<?php echo ($strCate[catename]); ?>"  maxlength="20"/></td>
	</tr>
	</tr>    
</table>
