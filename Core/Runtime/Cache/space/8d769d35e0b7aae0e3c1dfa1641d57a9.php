	...
	<div class="cleft">
    	<div class="">
        	<?php if(is_array($arrAlbum)): foreach($arrAlbum as $key=>$item): ?><div class="albumlst">
                ...
                <?php if($visitor[userid] == $user[userid]): ?>&gt;<a href="<?php echo U('space/photos/album',array('d'=>'edit','id'=>$item[albumid]));?>">修改相册属性</a>
                &nbsp;&gt;<a href="<?php echo U('space/photos/album',array('d'=>'upload','id'=>$item[albumid]));?>">添加照片</a><?php endif; ?>
                </div>
                <br>
