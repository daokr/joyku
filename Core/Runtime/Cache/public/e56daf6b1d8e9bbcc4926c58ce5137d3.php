...
<img src="<?php echo U('public/user/captcha');?>" url="index.php?app=public&m=user&a=captcha" onclick="javascript:newgdcode(this);" alt="点击刷新验证码" style="cursor:pointer; margin-left:5px; float:left;" align="absmiddle"/></td>
...
<div class="aside">
	...
	<p class="pl2">&gt; 已经拥有爱客网帐号? <a href="<?php echo U('public/user/login');?>" rel="nofollow">直接登录</a></p>
