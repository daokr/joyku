...
<div class="midder">
  ...
  <table width="100%" cellpadding="0" cellspacing="0" class="showtable">
      <tr>
        ...
        <?php if($touser[userid] > 0): ?><a href="<?php echo U('space/index/index',array('id'=>$touser[doname]));?>" class="nbg">
        ...
        <td valign="top">
          ...
          <?php if($type == 'inbox'): if($arrMessages[userid] != 0): ?><a class="submit"  title="回信" href="<?php echo U('public/message/write',array('touserid'=>$touser[userid]));?>">回信</a>&nbsp;&nbsp;&nbsp;&nbsp;<?php endif; ?>
          <a class="gray-submit" onclick="return confirm('真的要删除消息吗?')" title="删除" href="<?php echo U('public/message/doing',array('d'=>'del','type'=>'inbox','messageid'=>$arrMessages[messageid]));?>">删除</a><?php endif; ?>
          <?php if($type == 'outbox'): ?><a class="gray-submit" onclick="return confirm('真的要删除消息吗?')" title="删除" href="<?php echo U('public/message/doing',array('d'=>'del','type'=>'outbox','messageid'=>$arrMessages[messageid]));?>">删除</a><?php endif; ?>
          </td>
      </tr>
  </table>
        ...
        <div class="cright">
            <?php if($type == 'inbox'): ?><p class="pl2">&gt; <a href="<?php echo U('public/message/ikmail',array('d'=>'inbox'));?>">返回到我的收件箱</a></p>
			<p class="pl2">&gt; <a href="<?php echo U('space/index/index',array('id'=>$touser[doname]));?>">去<?php echo ($touser[username]); ?>的主页看看</a></p><?php endif; ?>
            <?php if($type == 'outbox'): ?><p class="pl2">&gt; <a href="<?php echo U('public/message/ikmail',array('d'=>'outbox'));?>">回我的发件箱</a></p>
            <p class="pl2">&gt; <a href="<?php echo U('public/message/ikmail',array('d'=>'inbox'));?>">去我的收件箱</a></p><br/>
			<p class="pl2">&gt; <a href="<?php echo U('space/index/index',array('id'=>$touser[doname]));?>">去<?php echo ($touser[username]); ?>的主页看看</a></p><?php endif; ?>           
        </div>
    </div>
</div>
