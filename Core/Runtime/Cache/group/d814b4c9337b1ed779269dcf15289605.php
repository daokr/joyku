...
<div class="mc">
	...
	<div class="group-cate-bd">
	   <?php if(is_array($arrGroupCate)): foreach($arrGroupCate as $key=>$item): ?><div class="group-cate">
	       <ul>
	            <li class="cate-label"><a href="<?php echo U('group/index/explore',array('tag'=>$item[pcate][catename]));?>"><b>•</b><?php echo ($item[pcate][catename]); ?></a></li>
	            <?php if(is_array($item["childCate"])): foreach($item["childCate"] as $key=>$citem): ?><li><a href="<?php echo U('group/index/explore_topic',array('tag'=>$citem[catename]));?>"><?php echo ($citem[catename]); ?></a></li><?php endforeach; endif; ?>
	       </ul>
	   </div><?php endforeach; endif; ?>
	</div>
   <script language="javascript">
   $(function(){$('.group-cate:odd').addClass('odd');})
   </script>  	
    </div>
