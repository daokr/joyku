...
<channel>
  ...
  <link><?php echo C('ik_site_url'); echo U('group/index/show',array('id'=>$strGroup[groupid]));?></link>
  ...
  <pubDate><?php echo date('Y-m-d H:i:s',$pubdate) ?></pubDate>
	<?php if(is_array($arrTopic)): foreach($arrTopic as $key=>$item): ?><item>
        ...
        <link><?php echo U('group/index/topic',array('id'=>$item[topicid]));?></link>
        ...
        <guid isPermaLink="true"><?php echo U('group/index/topic',array('id'=>$item[topicid]));?></guid>
