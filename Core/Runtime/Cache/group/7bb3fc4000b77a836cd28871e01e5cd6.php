   ...
   <div class="group-cate-bd">
   	   <?php if(is_array($arrGroupCate)): foreach($arrGroupCate as $key=>$item): ?><div class="group-cate">
	       <ul>
	      		...
	      		<?php if(is_array($item["childCate"])): foreach($item["childCate"] as $key=>$citem): ?><li><a href="<?php echo U('group/index/explore',array('tag'=>$citem[catename]));?>"><?php echo ($citem[catename]); ?></a></li><?php endforeach; endif; ?>
	       </ul>
       </div><?php endforeach; endif; ?>
   </div>
