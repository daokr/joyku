                ...
                <div class="groups">
                        <ul>
                            <?php if(is_array($arrMyAdminGroup)): foreach($arrMyAdminGroup as $key=>$item): ?><li class="item">
                                <div class="pic">
                                    <a href="<?php echo U('group/index/show',array('id'=>$item[groupid]));?>"><img alt="<?php echo ($item[groupname]); ?>" class="m_sub_img" src="<?php echo ($item[icon_48]); ?>" width="48" height="48"></a>
                                </div>
                            
                                <div class="info">
                                    <a href="<?php echo U('group/index/show',array('id'=>$item[groupid]));?>" title="<?php echo ($item[groupname]); ?>"><?php echo getsubstrutf8(t($item[groupname]),0,12) ?></a><br> 
