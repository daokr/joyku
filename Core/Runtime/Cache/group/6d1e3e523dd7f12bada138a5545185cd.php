...
<div class="obss"><dl class="obu"><dt><a class="nbg" href="<?php echo U('space/index/index',array('id'=>$strLeader[doname]));?>"><img alt="mido" class="m_sub_img" src="<?php echo ($strLeader[face]); ?>"></a></dt>
...
<div class="obss">
    <?php if(is_array($arrAdmin)): foreach($arrAdmin as $key=>$item): ?><dl class="obu">
            <dt><a class="nbg" href="<?php echo U('space/index/index',array('id'=>$item[doname]));?>"><img alt="<?php echo ($item[username]); ?>" class="m_sub_img" src="<?php echo ($item[face]); ?>"></a>
                <?php if($visitor[userid] == $strLeader[userid]): ?><span title="取消管理员" class="gact"><a title="取消<?php echo ($item[username]); ?>的管理员" class="j a_confirm_link" href="<?php echo U('group/index/group_user_set',array('d'=>'isadmin','userid'=>$item[userid],'groupid'=>$strGroup[groupid],'isadmin'=>'0'));?>" rel="nofollow">^</a></span><?php endif; ?>
            </dt>
...
<?php if(is_array($arrGroupUser)): foreach($arrGroupUser as $key=>$item): ?><dl class="obu">
        <dt>
        <a class="nbg" href="<?php echo U('space/index/index',array('id'=>$item[doname]));?>"><img alt="<?php echo ($item[username]); ?>" class="m_sub_img" src="<?php echo ($item[face]); ?>"></a>
        <?php if($visitor[userid] == $strLeader[userid]): if($item[isadmin] != 1): ?><span title="提升为管理员" class="gact"><a title="把<?php echo ($item[username]); ?>提升为管理员" class="j a_confirm_link" href="<?php echo U('group/index/group_user_set',array('d'=>'isadmin','userid'=>$item[userid],'groupid'=>$strGroup[groupid],'isadmin'=>'1'));?>" rel="nofollow">^</a></span>
            <br /><?php endif; ?>
            <?php if($item[userid] != $strGroup[userid]): ?><span title="踢出小组" class="gact"><a title="把<?php echo ($item[username]); ?>踢出小组" class="j a_confirm_link" href="<?php echo U('group/index/group_user_set',array('d'=>'isuser','userid'=>$item[userid],'groupid'=>$strGroup[groupid]));?>" rel="nofollow">k</a></span>
                <br /><?php endif; endif; ?>
...
<div class="cright">
<p class="pl2">&gt; <a href="<?php echo U('group/index/show',array('id'=>$strGroup[groupid]));?>">回<?php echo ($strGroup[groupname]); ?>小组</a></p>
