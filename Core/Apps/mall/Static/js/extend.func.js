...
function buildHtml(data){
	...
	'<div class="item"><label>宝贝标签：</label><input name="tags" id="tags" type="text" value="'+data.tags+'"  onblur="checkTag(this)" onkeyup="checkTag(this)" onkeydown="checkTag(this)" ></div>',
...
function fetch_item(obj,item){
		...
		//安全检查
		if($.ikphp.util.empty(intro) || $.ikphp.util.empty(title)){
			return;
		}
		if(!checkTag('#tags')){
			return;
