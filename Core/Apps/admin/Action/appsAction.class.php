...
class appsAction extends backendAction {
	...
	public function uninstall(){
		...
		foreach($appList as &$v){
			...
			$v['icon_url'] = empty($v['icon_url']) ? '<img src="'.APPS_PATH.$v['app_name'].'/Appinfo/icon_app.png" >' : "<img src='{$v['icon_url']}'>";
	...
	public function installed(){
		...
		foreach ($appList as $key=>$item){
			...
			$list[$key]['icon_url'] = empty($item['icon_url']) ? '<img src="'.APPS_PATH.$item['app_name'].'/Appinfo/icon_app.png" >' : "<img src='{$item['icon_url']}'>";
		}
